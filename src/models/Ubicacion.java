...
public class Ubicacion {
    ...
    public Ubicacion(String nombre, String descripcion) {
        ...
        this.ubicacionesAdyacentes = new ArrayList<>();
        this.esPuntoViajeRapido = false;
    ...
    public void agregarUbicacionAdyacente(Ubicacion ubicacion) {
        ubicacionesAdyacentes.add(ubicacion);
    }
